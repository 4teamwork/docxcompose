...
class TestIdentifyDocpropertiesInDocument(object):
    ...
    def test_identifies_simple_fields_correctly(self):
        ...
        assert 1 == len(properties), "input should contain 1 simple field docproperty"

        prop = properties[0]
        assert prop.name == "F\xfc\xfc"
    ...
    def test_identifies_complex_fields_correctly(self):
        ...
        for prop, indexes in zip(properties, expected_indexes):
            ...
            assert (
                prop.get_separate_run().getchildren()[1].attrib[attrib_key]
                == "separate"
            )
...
class TestUpdateAllDocproperties(object):
    ...
    def test_updates_doc_properties_in_header(self):
        ...
        assert_simple_field_value(
            "xxx", document.sections[0].header.part.element, "my.text-prop"
        )

        CustomProperties(document).update_all()

        assert_simple_field_value(
            "i'm some text", document.sections[0].header.part.element, "my.text-prop"
        )
    ...
    def test_updates_doc_properties_in_footer(self):
        ...
        assert_simple_field_value(
            "xxx", document.sections[0].footer.part.element, "my.text-prop"
        )

        CustomProperties(document).update_all()

        assert_simple_field_value(
            "b\xe4hh", document.sections[0].footer.part.element, "my.text-prop"
        )

    def test_updates_doc_properties_different_first_page(self):
        document = Document(
            docx_path("docproperties_different_first_page_1_section.docx")
        )

        assert_simple_field_value(
            "xxx", document.sections[0].first_page_header.part.element, "page1.header"
        )
        assert_simple_field_value(
            "xxx", document.sections[0].first_page_footer.part.element, "page1.footer"
        )
        assert_simple_field_value(
            "0", document.sections[0].header.part.element, "page2.header"
        )
        assert_simple_field_value(
            "01.01.1970", document.sections[0].footer.part.element, "page2.footer"
        )

        CustomProperties(document).update_all()

        assert_simple_field_value(
            "p1h", document.sections[0].first_page_header.part.element, "page1.header"
        )
        assert_simple_field_value(
            "p1f", document.sections[0].first_page_footer.part.element, "page1.footer"
        )
        assert_simple_field_value(
            "42", document.sections[0].header.part.element, "page2.header"
        )
        assert_simple_field_value(
            "18.10.1984", document.sections[0].footer.part.element, "page2.footer"
        )

    def test_updates_doc_properties_different_odd_even_pages(self):
        document = Document(
            docx_path("docproperties_different_odd_even_pages_1_section.docx")
        )

        assert_simple_field_value(
            "xxx", document.sections[0].header.part.element, "odd.header"
        )
        assert_simple_field_value(
            "xxx", document.sections[0].footer.part.element, "odd.footer"
        )
        assert_simple_field_value(
            "0", document.sections[0].even_page_header.part.element, "even.header"
        )
        assert_simple_field_value(
        ...
        assert_simple_field_value(
            "odd-header", document.sections[0].header.part.element, "odd.header"
        )
        assert_simple_field_value(
            "odd-footer", document.sections[0].footer.part.element, "odd.footer"
        )
        assert_simple_field_value(
            "1337", document.sections[0].even_page_header.part.element, "even.header"
        )
        assert_simple_field_value(
    ...
    def test_updates_docproperties_shared_footer(self):
        ...
        assert_complex_field_value("xxx", header_1.part.element, "section1.header")
        assert_complex_field_value("yyy", header_2.part.element, "section2.header")
        ...
        assert_complex_field_value("99", footer_1.part.element, "shared.footer")
        assert_complex_field_value("99", footer_2.part.element, "shared.footer")

        CustomProperties(document).update_all()

        assert_complex_field_value(
            "h\xe4der 1", header_1.part.element, "section1.header"
        )
        assert_complex_field_value(
            "h\xf6der 2", header_2.part.element, "section2.header"
        )

        # the same footer should be referenced by both sections
        footer_1 = document.sections[0].footer
        footer_2 = document.sections[1].footer
        assert_complex_field_value("123123123", footer_1.part.element, "shared.footer")
        assert_complex_field_value("123123123", footer_2.part.element, "shared.footer")
    ...
    def test_updates_docproperties_shared_header(self):
        ...
        assert_complex_field_value("xxx", header_1.part.element, "shared.header")
        assert_complex_field_value("xxx", header_2.part.element, "shared.header")

        footer_1 = document.sections[0].footer
        footer_2 = document.sections[1].footer
        assert not footer_1.is_linked_to_previous
        assert not footer_2.is_linked_to_previous
        assert_complex_field_value("123", footer_1.part.element, "section1.footer")
        assert_complex_field_value("yyy", footer_2.part.element, "section2.footer")

        CustomProperties(document).update_all()

        # the same header should be referenced by both sections
        assert_complex_field_value("sh\xe4red", header_1.part.element, "shared.header")
        assert_complex_field_value("sh\xe4red", header_2.part.element, "shared.header")

        footer_1 = document.sections[0].footer
        footer_2 = document.sections[1].footer
        assert_complex_field_value("-1.0", footer_1.part.element, "section1.footer")
        assert_complex_field_value(
            "f\xfc\xfcter", footer_2.part.element, "section2.footer"
        )

    def test_updates_docproperties_shared_header_footer(self):
        document = Document(
            docx_path("docproperties_shared_header_footer_2_sections.docx")
        )
        ...
        assert not header_1.is_linked_to_previous
        assert header_2.is_linked_to_previous
        assert_complex_field_value("blub", header_1.part.element, "shared.header")
        assert_complex_field_value("blub", header_2.part.element, "shared.header")
        ...
        assert not footer_1.is_linked_to_previous
        assert footer_2.is_linked_to_previous
        assert_complex_field_value("N", footer_1.part.element, "shared.footer")
        assert_complex_field_value("N", footer_2.part.element, "shared.footer")

        CustomProperties(document).update_all()

        # the same header should be referenced by both sections
        assert_complex_field_value("ig bi obe", header_1.part.element, "shared.header")
        assert_complex_field_value("ig bi obe", header_2.part.element, "shared.header")

        # the same footer should be referenced by both sections
        footer_1 = document.sections[0].footer
        footer_2 = document.sections[1].footer
        assert_complex_field_value("Y", footer_1.part.element, "shared.footer")
        assert_complex_field_value("Y", footer_2.part.element, "shared.footer")
    ...
    def test_updates_doc_properties_with_umlauts(self):
        ...
        assert_simple_field_value("j\xe4ja.", document.element.body, "F\xfc\xfc")
    ...
    def test_complex_docprop_fields_with_multiple_textnodes_are_updated(self):
        ...
        assert len(cached_values) == 4, "doc property value is scattered over 4 parts"
    ...
    def test_complex_docprop_with_multiple_textnode_in_same_run_are_updated(self):
        ...
        w_p = paragraphs[0]
        cached_values = cached_complex_field_values(w_p)
        assert len(cached_values) == 2, "doc property value is scattered over 2 parts"
    ...
    def test_multiple_identical_docprops_get_updated(self):
        ...
        for i, paragraph in enumerate(document.paragraphs):
            assert paragraph.text == "Bar", "docprop {} was not updated".format(i + 1)
    ...
    def test_docproperty_without_separate_does_get_updated(self):
        ...
        assert paragraphs[0].text == "Sachbearbeiter: "
        assert "Sachbearbeiter: " in fullname.w_p.xml
        assert paragraphs[1].text == "Dossier Titel:  "

        custom_properties.update_all()

        # Field with missing separate was not updated
        assert paragraphs[0].text == "Sachbearbeiter: Test User"
        # Next field was updated correctly
        assert paragraphs[1].text == "Dossier Titel:  Some Title"
    ...
    def test_date_docprops_with_format_get_updated(self):
        ...
        expected_values = ["23.01.20", "jeudi 23 janvier 2020", "23-1-20 10:0:0"]
        for i, (expected, paragraph) in enumerate(
            zip(expected_values, document.paragraphs)
        ):
            assert (
...
class TestUpdateSpecificDocproperty(object):
    ...
    def test_simple_field_gets_updated(self):
        ...
        CustomProperties(document).update("F\xfc\xfc", "new v\xe4lue")

        assert_simple_field_value("new v\xe4lue", document.element.body, "F\xfc\xfc")
    ...
    def test_complex_field_gets_updated(self):
        ...
        expected_paragraphs[2] = "Number: 423"
        actual_paragraphs = [paragraph.text for paragraph in document.paragraphs]
        assert actual_paragraphs == expected_paragraphs
    ...
    def test_multiple_identical_docprops_get_updated(self):
        ...
        for i, paragraph in enumerate(document.paragraphs):
            assert paragraph.text == "New value", "docprop {} was not updated".format(
                i + 1
            )
...
class TestDissolveField(object):
    ...
    def test_removes_simple_field_but_keeps_value(self):
        document = Document(docx_path("outdated_docproperty_with_umlauts.docx"))
        assert len(document.paragraphs) == 1, "input file should contain 1 paragraph"
        fields = xpath(document.element.body, simple_field_expression("F\xfc\xfc"))
        assert len(fields) == 1, "should contain one simple field docproperty"

        assert document.paragraphs[0].text == "Hie chund ds property: "
        assert fields[0].text == "xxx"

        CustomProperties(document).dissolve_fields("F\xfc\xfc")
        fields = xpath(document.element.body, simple_field_expression("F\xfc\xfc"))
        ...
        assert document.paragraphs[0].text == "Hie chund ds property: xxx"
    ...
    def test_removes_complex_field_but_keeps_value(self):
        ...
        properties = xpath(document.element.body, ".//w:instrText")
        assert len(properties) == 4, "only 4 fields should remain after removal of one"
...
def test_get_doc_properties():
    ...
    assert props.get("Date Property") == datetime(
        2019, 6, 11, 10, 0, tzinfo=timezone.utc
    )
...
def test_add_doc_properties():
    ...
    props.add(
        "My Date Property", datetime(2019, 10, 23, 15, 44, 50, tzinfo=timezone.utc)
    )
    assert props.get("My Date Property") == datetime(
        2019, 10, 23, 15, 44, 50, tzinfo=timezone.utc
    )
...
def test_add_utf8_property():
    ...
    props.add("My Text Property", "f\xfc\xfc".encode("utf-8"))
    assert props.get("My Text Property") == "f\xfc\xfc"
...
def test_delete_doc_properties():
    ...
    assert xpath(props._element, ".//cp:property/@pid") == ["2", "3", "4"]
...
def test_doc_properties_values():
    ...
    assert props.values() == [
        ...
        123,
        True,
        datetime(2019, 6, 11, 10, 0, tzinfo=timezone.utc),
        1.1,
    ]
...
def test_vt2value_value2vt_roundtrip():
    ...
    assert vt2value(value2vt("foo")) == "foo"
    assert vt2value(value2vt("")) == ""
